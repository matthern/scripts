...
for filename in os.listdir(conf_dir):
    ...
    if not server_regex.search(contents):
        ...
        print(f'Added include directive to server block in file: {filename}')
    else:
        print(f'Skipping server block of {filename}')
    ...
    if not location_regex.search(contents):
        ...
        print(f'Added include directive to location block in file: {filename}')
    else:
        print(f'Skipping location block of {filename}')
